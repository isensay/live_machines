...
use App\Models\Livemachines\ValueModel;
...
class ValueController extends Controller {
    ...
    public function __construct() {
        ...
        $this->valueModel   = new ValueModel([], $this->dbConnection);
    }
    ...
    public function index() {
        return view('livemachines/value', [
    ...
    public function data(Request $request) {
        ...
        $result = $this->valueModel->get_list($search, $start, $length, $orderColumn, $orderDir);
    ...
    public function create(Request $request) {
        ...
        $id = $this->valueModel->get_id_from_name($name);
        ...
        // Создаем группу
        $id = $this->valueModel->get_id_from_name($name, true);
    ...
    public function edit(Request $request, int $id) {
        ...
        // Получаем информацию
        $info = $this->valueModel->get_info_from_id($id);
    ...
    public function update(Request $request, $id) {
        ...
        // Обновляем даные
        $result = $this->valueModel->set($id, $name);
    ...
    public function remove(int $id) {
        ...
        $result = $this->valueModel->remove($id);
