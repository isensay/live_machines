...
return [
    ...
    | такие как правила размера. Не стесняйтесь настраивать эти сообщения здесь.
    |
    */
    ...
    | быстро указать конкретное пользовательское сообщение для данного правила атрибута.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие строки используются для замены заполнителя атрибута
    | на что-то более удобочитаемое, например, "Адрес электронной почты" вместо
