        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <div class="mt-3 text-center">
                    ...
                    <p class="text-muted mt-2"> A email has been send to <span class="fw-medium">youremail@domain.com</span>.
                        Please check for an email from company and click on the included link to
                        reset your password. </p>

                    <div class="d-grid">
                        <a href="{{ route('login') }}" class="btn btn-primary waves-effect waves-light mt-3">Back to Login</a>
                    </div>
                </div>
