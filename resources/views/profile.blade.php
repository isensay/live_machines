    ...
    <div class="row">
        <div class="col-lg-4 col-xl-4">
            <div class="card text-center">
                <div class="card-body">
                    <img src="/source/base/images/users/avatar-0.jpg" class="rounded-circle avatar-xl img-thumbnail"
                    alt="profile-image">

                    <h4 class="mt-3 mb-0"> {{ Auth::user()->name }} {{ Auth::user()->surname }} </h4>
                    <p class="text-muted">@petrominkin</p>

                    <button type="button" class="btn btn-success btn-xs waves-effect mb-2 waves-light"> {{ __('profile.about.buttons.follow') }} </button>
                    <button type="button" class="btn btn-danger btn-xs waves-effect mb-2 waves-light"> {{ __('profile.about.buttons.message') }} </button>

                    <div class="text-start mt-3">
                        <h4 class="font-13 text-uppercase"> {{ __('profile.about.about_me') }} :</h4>
                        <p class="text-muted font-13 mb-3">
                            Это просто фиктивный текст для полиграфической промышленности.
                            Lorem Ipsum был стандартным в отрасли фиктивным текстом с 1500-х годов,
                            когда неизвестный печатник взял набор шрифтов и скремблировал его,
                            чтобы создать книгу с образцами шрифтов. Он пережил не только пять столетий,
                            но и скачок в электронный набор текста, оставаясь практически неизменным.
                        </p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-sm">
                                <tbody>
                                    <tr>
                                        <th scope="row"> {{ __('profile.about.full_name') }} :</th>
                                        <td class="text-muted">{{ Auth::user()->name }} {{ Auth::user()->surname }}</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"> {{ __('profile.about.phone') }} :</th>
                                        <td class="text-muted">(123) 123 1234</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"> {{ __('profile.about.email') }} :</th>
                                        <td class="text-muted">user@email.domain</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"> {{ __('profile.about.location') }} :</th>
                                        <td class="text-muted">Russia</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title"> {{ __('profile.skills.title') }} </h4>
                    <p class="sub-header font-13 mb-3"> {{ __('profile.skills.description') }} </p>
                ...
                <div class="card-body">
                    <ul class="nav nav-pills navtab-bg">
                        <li class="nav-item">
                            <a href="#about-me" data-bs-toggle="tab" aria-expanded="true" class="nav-link active ms-0">
                                ...
                                {{ __('profile.experience.buttons.about_me') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#settings" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                                <i class="mdi mdi-cog me-1"></i>
                                {{ __('profile.experience.buttons.settings') }}
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="about-me">
                            ...
                            <h5 class="mb-4 text-uppercase"> {{ __('profile.experience.title') }} </h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            <th>#</th>
                                            <th> {{ __('profile.projects.table_titles.project_name') }} </th>
                                            <th> {{ __('profile.projects.table_titles.start_date') }} </th>
                                            <th> {{ __('profile.projects.table_titles.due_date') }} </th>
                                            <th> {{ __('profile.projects.table_titles.status') }} </th>
                                            <th> {{ __('profile.projects.table_titles.client') }} </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>01/01/2015</td>
                                            <td>10/15/2018</td>
                                            <td><span class="badge bg-info"> {{ __('profile.project_status.work_in_progress') }} </span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>21/07/2016</td>
                                            <td>12/05/2018</td>
                                            <td><span class="badge bg-success"> {{ __('profile.project_status.pending') }} </span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>18/03/2018</td>
                                            <td>28/09/2018</td>
                                            <td><span class="badge bg-pink"> {{ __('profile.project_status.done') }} </span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>02/10/2017</td>
                                            <td>07/05/2018</td>
                                            <td><span class="badge bg-danger"> {{ __('profile.project_status.on_hold') }} </span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>17/01/2017</td>
                                            <td>25/05/2021</td>
                                            <td><span class="badge bg-warning"> {{ __('profile.project_status.coming_soon') }} </span></td>
                                            <td>Karel Auberjo</td>
                                        </tr>
