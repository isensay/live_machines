                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="basic-datatable" 
                                        ...
                                        data-url="{{ route('lm_model_data') }}"
                                        data-create-url="{{ route('lm_model_create') }}"
                                        data-edit-url="{{ route('lm_model_edit', ['id' => 'REPLACE_WITH_ID']) }}"
                                        data-update-url={{ route('lm_model_update', ['id' => 'REPLACE_WITH_ID']) }}
                                        data-delete-url={{ route('lm_model_remove', ['id' => 'REPLACE_WITH_ID']) }}
                                    >
                                        <thead>
                                            <tr>
                                                <th>Название</th>
                                                <th width="10%">Производителей</th>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <label for="edit_name" class="form-label">
                                                Название модели <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" class="form-control" id="edit_name" 
                                                   name="name" required placeholder="Введите название модели">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('head_other')
    ...
    <link href="/source/base/livemachines/model/style.css?<?=time()?>" rel="stylesheet" type="text/css" />
@endsection
...
@section('page_more_java_script')
    ...
    <script src="/source/base/livemachines/model/script.js?<?=time()?>"></script>
@endsection