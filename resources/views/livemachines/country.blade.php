        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="editCountryModalLabel">
                ...
                <div class="modal-footer">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <button type="button" class="btn btn-success" id="saveCountryBtn">
...
@section('head_other')
    ...
    <link href="/source/base/livemachines/country/style.css?<?=time()?>" rel="stylesheet" type="text/css" />
@endsection
