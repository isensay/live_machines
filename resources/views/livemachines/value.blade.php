                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="basic-datatable" 
                                        ...
                                        data-url="{{ route('lm_value_data') }}"
                                        data-create-url="{{ route('lm_value_create') }}"
                                        data-edit-url="{{ route('lm_value_edit', ['id' => 'REPLACE_WITH_ID']) }}"
                                        data-update-url={{ route('lm_value_update', ['id' => 'REPLACE_WITH_ID']) }}
                                        data-delete-url={{ route('lm_value_remove', ['id' => 'REPLACE_WITH_ID']) }}
                                    >
                                        <thead>
                                            <tr>
                                                <th>Название</th>
...
@section('head_other')
    ...
    <link href="/source/base/livemachines/value/style.css?<?=time()?>" rel="stylesheet" type="text/css" />
@endsection
...
@section('page_more_java_script')
    ...
    <script src="/source/base/livemachines/value/script.js?<?=time()?>"></script>
@endsection